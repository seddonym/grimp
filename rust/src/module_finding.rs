...
pub struct FoundPackage {
    ...
    // BTreeSet rather than HashSet seems to be necessary to make FoundPackage hashable.
...
/// It extracts 'name', 'directory', and converts the 'module_files' frozenset into a Rust HashSet.
